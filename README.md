...
This is a personally-maintained fork of Roslyn -- the C# and VB.NET compiler -- in which I experiment with adding additional language features to C#. These ideas vary and are initially developed on branches before being merged into `master`. They are maintained in `master` once merged.
